...
logger("org", ERROR, ["STDOUT", "file"], false)
logger("org.springframework", ERROR, ["STDOUT", "file"], false)
logger("org.hibernate", INFO, ["STDOUT", "file"], false)
logger("org.hibernate.SQL", DEBUG, ["STDOUT", "file"], false)
logger("org.apache.camel", DEBUG, ["STDOUT", "file"], false)
logger("com.avvero", TRACE, ["STDOUT", "file"], false)
